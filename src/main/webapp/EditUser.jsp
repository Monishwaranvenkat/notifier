          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form id="signupform" name="signupform" action="/edituser" method="post" class="text-left ">
                  <span><label id="login-error" class="error" for="loginform">
                  <%=(request.getAttribute("errMessage") == null) ? "": request.getAttribute("errMessage")%>
                  </label></span>
                  	 <div class="form-group">
                      <input id="username" type="text" value="${user.userName}" name="username" class="input-material">
                      <label for="username" class="label-material">Username</label>
                      <span><label id="username-error" class="error" for="username"></label></span>
                    </div>
                    <div class="form-group">
                      <input id="phone" type="text" value="${user.mobileNumber}" name="phone" class="input-material">
                      <label for="phone" class="label-material">Phone Number</label>
                      <span><label id="phone-error" class="error" for="phone"></label></span>
                    </div>
                     <div class="form-group">
                      <input id="email" type="email" value="${user.email}" name="email" class="input-material">
                      <label for="email" class="label-material">Email</label>
                      <span><label id="email-error" class="error" for="email"></label></span>
                    </div>
                    <div class="form-group">
                      <input id="password" type="password" value="${user.password}" name="password" class="input-material">
                      <label for="password" class="label-material">Password</label>
                      <span><label id="password-error" class="error" for="password"></label></span>
                    </div>
                     <div class="form-group">
                      <input id="confirmPassword" type="password" value="${user.password}" name="confirmPassword" class="input-material">
              ...
              <input id="register" type="submit"class="btn btn-primary">
                        <a href="/notebook" class="btn btn-danger">cancel</a>
            </div>
